...
**Reste en Phase A3** : A3.10 (recette finale Volet A, verrou de gouvernance avant le Volet B). Le Volet B (pipeline de données réelles) a démarré en parallèle malgré ce verrou théorique : voir la section « Pipeline (Volet B) » plus bas. Détail complet, échéances et responsables : `Plan_Implementation_NEV_Climate_Data.xlsx`, onglet « Plan d'implémentation ».
