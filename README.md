...
**État** : les 13 pages sont migrées (Lots 0 à 5). A3.1 (hub Mercure) et A3.2 (`useMercureKpis()`, déjà câblé dans `VisualizationsPage.jsx` avec repli automatique sur les agrégats REST tant que le hub n'est pas joignable) restent à finaliser côté infrastructure - voir la section dédiée plus bas une fois faite.
